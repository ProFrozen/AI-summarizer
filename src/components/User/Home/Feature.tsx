...
const Feature = () => {
  ...
  return (
    <section id="features" className="ig zk oo">
      <div className="of op">

        <div className="wow fadeInUp e ia wa sc hg kh ml ro" data-wow-delay=".2s"
        ...
        <div className="ja hb md pd">
          <div className="yb of yl/2 pn/3">
            <div className="wow fadeInUp bj ia pa tc kh nl" data-wow-delay=".2s"
              style={{visibility: "visible", animationDelay: "0.2s"}}>
              <div className="ia ra hb tb fc od pd ee se af ei ti dj ej fj vj zj _j hk ik ol tl zl">
                <svg width="44" height="44" viewBox="0 0 44 44" className="if">
              ...
              <div>
                <h3 className="ab lh th xh di _j el pl">
          ...
          <div className="yb of yl/2 pn/3">
            <div className="wow fadeInUp bj ia pa tc kh nl" data-wow-delay=".25s"
          ...
          <div className="yb of yl/2 pn/3">
            <div className="wow fadeInUp bj ia pa tc kh nl" data-wow-delay=".3s"
          ...
          <div className="yb of yl/2 pn/3">
            <div className="wow fadeInUp bj ia pa tc kh nl" data-wow-delay=".35s"
          ...
          <div className="yb of yl/2 pn/3">
            <div className="wow fadeInUp bj ia pa tc kh nl" data-wow-delay=".4s"
          ...
          <div className="yb of yl/2 pn/3">
            <div className="wow fadeInUp bj ia tc kh nl" data-wow-delay=".45s"
