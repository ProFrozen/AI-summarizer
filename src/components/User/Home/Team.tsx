...
import img1 from "../../../images/team/3.png";
import img2 from "../../../images/team/me.png";

const Team = () => {

  return (
    <section id="team" className="ig zk oo">
      <div className="of op">

        <div className="wow fadeInUp e ia wa hg kh ml ro" data-wow-delay=".2s"
          style={{visibility: "visible", animationDelay: "0.2s", animationName: "none"}}>
          <span className="title"> OUR TEAM </span>
          <h2 className="ia oa sc lh oh wh di _j dl qm um">
            Meet With Our Creative Dedicated Team
          </h2>
          <p className="ia sc mh bi">
        ...
        <div className="ja hb md pd">
          <div className="yb of yl/2 pn/4">
            <div className="wow fadeInUp bj ia pa wc kh fq" data-wow-delay=".2s"
              style={{visibility: "visible", animationDelay: "0.2s", animationName: "none"}}>
              <div className="e na _d de">
                <img src={img1} alt="team-image" className="yb"
                  data-xblocker="passed" style={{visibility: "visible"}} />
                  <div className="duration-300 d w o/2 dd/2 ed ki ti cj gj">
                    <div className="hb od pd wd">
                      <a href="javascript:void(0)" aria-label="social-icon"
                        className="hb pb cc od pd ee he me pe re bf ci ri ti wi xi zi">
          ...
          <div className="yb of yl/2 pn/4">
            <div className="wow fadeInUp bj ia pa wc kh fq" data-wow-delay=".25s"
              style={{visibility: "visible", animationDelay: "0.25s", animationName: "none"}}>
              <div className="e na _d de">
                <img src={img2} alt="team-image" className="yb"
                  data-xblocker="passed" style={{visibility: "visible"}} />
                  <div className="duration-300 d w o/2 dd/2 ed ki ti cj gj">
                    <div className="hb od pd wd">
                      <a href="javascript:void(0)" aria-label="social-icon"
          ...
          <div className="yb of yl/2 pn/4">
            <div className="wow fadeInUp bj ia pa wc kh fq" data-wow-delay=".3s"
              style={{visibility: "visible", animationDelay: "0.3s", animationName: "none"}}>
              <div className="e na _d de">
                <img src={img1} alt="team-image" className="yb"
                  data-xblocker="passed" style={{visibility: "visible"}} />
                  <div className="duration-300 d w o/2 dd/2 ed ki ti cj gj">
