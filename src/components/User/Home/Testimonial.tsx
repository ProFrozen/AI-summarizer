...
const Testimonial = () => {
  ...
  return (
    <section id="testimonial" className="ig zk oo">
      <div className="of op">

        <div className="wow fadeInUp e ia wa hg kh ml ro" data-wow-delay=".2s"
          style={{animationDelay: "0.2s", animationName: "none"}}>
          <span className="title"> Testimonial </span>
          <h2 className="ia oa yc lh oh wh di _j dl qm um">
        ...
        <div className="yb of">
          <div className="wow fadeInUp e da _d de ff gf _f dh eh pi bk vk cm km xo" data-wow-delay=".3s"
            style={{animationDelay: "0.3s", animationName: "none"}}>
            <div className="d f g ea ob yb ff gf li ak ef"></div>
            <div className="d h o/2 ea dd/2">
              <svg width="1174" height="560" viewBox="0 0 1174 560" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.4" filter="url(#filter0_f_41_257)">
                  <rect x="450.531" y="279" width="272.933" height="328.051" fill="url(#paint0_linear_41_257)"></rect>
                </g>
                <defs>
                  <filter id="filter0_f_41_257" x="0.531494" y="-171" width="1172.93" height="1228.05"
                    ...
                    <fegaussianblur stdDeviation="225" result="effect1_foregroundBlur_41_257"></fegaussianblur>
                  </filter>
            ...
            <div className="tns-outer" id="tns1-ow">
              <div className="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button"
                data-controls="prev" aria-controls="tns1"><svg width="20" height="20" viewBox="0 0 20 20"
                  className="if">
                  <path
                ...
                </svg></button><button type="button" data-controls="next" aria-controls="tns1"><svg
                  width="20" height="20" viewBox="0 0 20 20" className="if">
                  <path
              ...
              <div className="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span
                className="current">3</span> of 2</div>
              <div id="tns1-mw" className="tns-ovh">
                <div className="tns-inner" id="tns1-iw">
                  <div className="testimonial-active  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="tns1"
                    style={{transitionDuration: "0s", transform: "translate3d(-33.3333%, 0px, 0px)"}}>
                    <div className="testimonial-item tns-item tns-slide-cloned" aria-hidden="true">
                      <div className="ja hb md od">
                        <div className="ha yb of an pn/2">
                          <div className="kh _o">
                            <p className="sa lh mh zh bi ep _p">
                        ...
                        <div className="yb of pn/2">
                          <div className="lg:mr-0 e ia sa vb yb zc cn">
                            <div className="d j p da">
                              <img src={img1} alt="testimonial-image"
                                data-xblocker="passed" style={{visibility: "visible"}} />
                                <div className="d x u ea ob yb he ne pe se af qi oj rj vj yj"></div>
                            </div>
                            <div className="d y z fa">
                    ...
                    <div className="testimonial-item tns-item tns-slide-active" id="tns1-item0">
                      <div className="ja hb md od">
                        <div className="ha yb of an pn/2">
                          <div className="kh _o">
                            <p className="sa lh mh zh bi ep _p">
                    ...
                    <div className="testimonial-item tns-item" id="tns1-item1" aria-hidden="true">
                      <div className="ja hb md od">
                        <div className="ha yb of an pn/2">
                          <div className="kh _o">
                            <p className="sa lh mh zh bi ep _p">
