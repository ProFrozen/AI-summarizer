...
const About = () => {
  ...
  return (
    <section id="support" className="ig zk oo">
      <div className="of op">
        <div className="ja hb md pd">
          <div className="yb of rp/12">
            <div className="hb md od ie ih jj zo">
              <div className="yb of pn/2">

                <div className="wow fadeInUp e wa xc hg ql ro" data-wow-delay=".2s"
                  style={{visibility: "visibility", animationDelay: "0.2s", animationName: "none"}}>
                  <span className="title _ gd">
                    SUPPORT
                  </span>
                  <h2 className="oa lh oh wh di _j dl qm um">
              ...
              <div className="yb of pn/2">
                <div className="wow fadeInUp hb od" data-wow-delay=".2s"
                  style={{visibility: "visibility", animationDelay: "0.2s", animationName: "none"}}>
                  <span className="eb wb yb _c _e vj"></span>
                  <a href="mailto:info@gostartup.com" className="lh th di _j rm bp cq">
                    info@gostartup.com
                  </a>
                </div>
              </div>
            </div>
            <div className="wow fadeInUp ja hb md pg" data-wow-delay=".2s"
              style={{visibility: "visibility", animationDelay: "0.2s", animationName: "none"}}>
              <div className="yb of yl/2 pn/4">
                <div className="ra">
                  <h3 className="db lh mh di _j gl">
                    Email Address
                  </h3>
                  <p className="mh xh bi">
                    support@startup.com
                  </p>
                </div>
              </div>
              ...
              <div className="yb of yl/2 pn/4">
                <div className="ra hb od td wn">
                  <a href="javascript:void(0)" name="social-link" aria-label="social-link" className="bi _i ek">
                    <svg width="24" height="24" viewBox="0 0 24 24" className="if">
                      <path
        ...
        <div className="ia ad mg">
          <form className="wow fadeInUp" data-wow-delay=".2s" action="https://formbold.com/s/unique_form_id" method="POST"
            style={{visibility: "visibility", animationDelay: "0.2s", animationName: "none"}}>
            <div className="ja hb md">
              <div className="yb of ok/2">
                <div className="wa">
                  <label for="name" className="ab fb lh mh di _j">
                    Your Name
                  </label>
                  <input type="text" name="name" id="name" placeholder="Full Name"
                    className="yb ie ve tf mh xh di ii oi aj mj _j gk" />
                </div>
              </div>
              <div className="yb of ok/2">
                <div className="wa">
                  <label for="email" className="ab fb lh mh di _j">
                    Email Address
                  </label>
              ...
              <div className="yb of ok/2">
                <div className="wa">
                  <label for="phone" className="ab fb lh mh di _j">
                    Phone (Optional)
                  </label>
              ...
              <div className="yb of ok/2">
                <div className="wa">
                  <label for="subject" className="ab fb lh mh di _j">
                    Subject
                  </label>
              ...
              <div className="yb of">
                <div className="pa">
                  <label for="message" className="ab fb lh mh di _j">
                    Message
                  </label>
                  <textarea rows="4" name="message" id="message" placeholder="Type Message"
                    className="yb kd ie ve tf mh xh di ii oi aj mj _j gk"></textarea>
                </div>
              </div>
              <div className="yb of">
                <div className="wa">
                  <label for="supportCheckbox" className="hb id jd bi _i">
                    <div className="e">
                      <input type="checkbox" id="supportCheckbox" className="b" />
                        <div className="box va ya hb nb _b od pd de he nj">
                          <span className="ki">
                            <svg width="11" height="8" viewBox="0 0 11 8" fill="none" className="jf">
                              <path
              ...
              <div className="yb of">
                <button className="hb yb od pd de se pf qf lh mh ci yi">
                  Send Message
                </button>
              </div>
            </div>
