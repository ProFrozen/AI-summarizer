...
const Slider = () => {
  ...
  return (
    <section id="home" className="e fa _d ug vg _k po qo" style={{backgroundColor: '#d1d1f7'}}>
      <div className="of op">
        <div className="ja hb md od">
          <div className="yb yf pn/2">
            <div className="ia wa qc kh bn cn _o">
              <span className="wow fadeInUp na gb ee se af zf lf lh mh ei vj yj _j">
                <span className="_a gb rb ec ee se"></span>
                SalesSummarizer
              </span>
              <h1 className="wow fadeInUp oa lh qh wh _j dl qm um " data-wow-delay=".3s"
                style={{visibility: "visible", animationDelay: "0.3s", color: "rgb(43, 28, 80)"}}>
                Save time by using 

                <span className="txt-type hi" data-wait="3000"
                  data-words="[&quot;Startup&quot;, &quot;SaaS&quot;, &quot;Business&quot;, &quot;Agency&quot;]"><span
                    className="txt"> Summarizer</span></span>
              </h1>
              <p className="wow fadeInUp wa mh bi" data-wow-delay=".4s" style={{color: "rgb(61, 46, 124)"}}>
                Record your messy thoughts.
                Instantly, 99% accurate transcriptions are generated and summarized.
              </p>
              <div className="wow fadeInUp hb md od pd vn" data-wow-delay=".5s"
                style={{visibility: "visible", animationDelay: "0.5s"}}>
                <a href="/record" className="ib od de se zf nf lh mh ci yi em fm">
                  Get Started
                  <span className="dg">
                ...
                <a href="" className="ib od de pf qf lh mh di _i _j fk">
                  <span className="ng">
          ...
          <div className="yb of pn/2">
            <div className="wow fadeInRight e ga ia sb yb rc bn" data-wow-delay=".3s"
              style={{visibility: "visible", animationDelay: "0.3s"}}>
              <div className="d f k qn/12">
                <img src={img2} alt="hero-image" data-xblocker="passed"
                  style={{visibility: "visible"}} />
              </div>
              <div className="d g h da">
                <img src={img1} alt="hero-image" data-xblocker="passed"
                  style={{visibility: "visible"}} />
                  <div className="d r s ea ob yb he ne pe se af qi oj rj vj yj"></div>
              </div>
              <div className="d g h">
      ...
      <div className="d h g ea ob yb ff gf li ak ef"></div>
      <div className="d f k ea">
