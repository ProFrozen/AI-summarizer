...
const About = () => {
  ...
  return (
    <section id="about" className="ig zk oo">
      <div className="of op">

        <div className="wow fadeInUp e ia wa hg kh dn ro" data-wow-delay=".2s"
          style={{visibility: "visible", animationDelay: "0.2s"}} >
          <span className="title"> ABOUT US </span>
          <h2 className="ia oa uc lh oh wh di _j dl qm um">
            Know Details About Our Company
          </h2>
          <p className="ia uc mh bi">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
            convallis tortor eros. Donec vitae tortor lacus. Phasellus aliquam
            ante in maximus.
          </p>
        </div>
        <div className="wow fadeInUp e da _d de qf wg xg gm jm io so up xp" data-wow-delay=".3s"
          ...
          <div className="tabButtons hb yb od rd">
            <button className="yb ie sf yg zg lh mh xh vi _i pj _j ck to uo ei ne qj" onclick="showPanel(0)">
              About Us
            </button>
            <button className="yb ie sf yg zg lh mh xh vi _i pj _j ck to uo" onclick="showPanel(1)">
              Our Mission
            </button>
            <button className="yb ie sf yg zg lh mh xh vi _i pj _j ck to uo" onclick="showPanel(2)">
              Our Vision
            </button>
          </div>
          <div className="yb">
            <div className="tabPanel" style={{display: "flex"}}>
              <div className="ja hb md od _g">
                <div className="yb of pn/2">
                  <div className="e ga xa ub vc cn">
                    <div className="d g f">
                      <img src={img2} alt="about-image"
                        data-xblocker="passed" style={{visibility: "visible"}} />
                    </div>
                    <div className="d k i/2 da cd/2">
                      <img src={img1} alt="about-image"
                        data-xblocker="passed" style={{visibility: "visible"}} />
                        <div className="d t u ea ob yb he ne pe se af qi oj rj vj yj"></div>
                    </div>
                    <div className="d k v fa">
                ...
                <div className="yb of pn/2">
                  <div className="max-w-[565px] en">
                    <h2 className="na lh qh yh di _j fl kl">
                      We are Creative Digital Agency Based in USA
                    </h2>
                    <p className="ra mh bi">
            ...
            <div className="tabPanel" style={{display: "none"}}>
              <div className="ja hb md od _g">
                <div className="yb of pn/2">
                  <div className="e ga xa ub vc cn">
                    <div className="d g f">
                      <img src="./GoStartup - Tailwind CSS Template_files/image-1(1).jpg" alt="about-image"
                        data-xblocker="passed" style={{visibility: "visible"}} />
                    </div>
                    <div className="d k i/2 da cd/2">
                      <img src="./GoStartup - Tailwind CSS Template_files/image-2(1).jpg" alt="about-image"
                        data-xblocker="passed" style={{visibility: "visible"}} />
                        <div className="d t u ea ob yb he ne pe se af qi oj rj vj yj"></div>
                    </div>
                    <div className="d k v fa">
