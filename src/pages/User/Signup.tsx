...
const Signup = () => {
  return <div className="pb-12">
    <section className="wow fadeInUp fg mo" data-wow-delay=".2s" style={{visibility: "visible", animationDelay: "0.2s"}}>
      <div className="of op">
        <div className="ie vg jj">
          <div className="ja hb md">
            <div className="yb of">
              <div className="ia nc de he re ag nf kj wj rk">
                <h3 className="ab lh qh xh iq _j il fp dq eq">
                  Create your Account
                </h3>
                <p className="wa mh xh bi">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>
                <h3 className="na lh th di _j">
                  Sign Up with Social Media
                </h3>
                <div className="wa hb od xd">
                  <button className="hb kb hc od pd de he mh bi kj tj pk yk">
                    <span className="cl">
                    ...
                    <span className="jb mk">
                      Sign up with Google
                    </span>
                  </button>
                  <button className="hb kb hc od pd de he kj tj">
                  ...
                  <button className="hb kb hc od pd ge he kj tj">
                ...
                <div className="e da na hb od pd">
                  <span className="d i/2 g ea jb xb yb cd/2 lq xj lk"></span>
                  <p className="re mh xh bi wj tk">
                  ...
                  <div className="ja hb md">
                    <div className="yb of ok/2">
                      <div className="pa">
                        ...
                        <input type="text" name="name" placeholder="Jhon Andrio"
                    ...
                    <div className="yb of ok/2">
                      <div className="pa">
                        ...
                        <input type="email" name="email" placeholder="jhonandrio@domain.com"
                          className="yb ie ve tf mh xh di ii oi aj mj _j gk" />
                      </div>
                    </div>
                    <div className="yb of ok/2">
                      <div className="pa">
                        <label for="password" className="ab fb lh mh di _j">
                          Password
                        </label>
                    ...
                    <div className="yb of ok/2">
                      <div className="pa">
                        <label for="re-password" className="ab fb lh mh di _j">
                          Retype Password
                        </label>
                        <input type="password" name="re-password" placeholder="**********"
                          className="yb ie ve tf mh xh di ii oi aj mj _j gk" />
                      </div>
                    </div>
                    <div className="yb of">
                      <div className="na">
                        <label for="supportCheckbox" className="hb bd id jd bi _i">
                          <div className="e">
                    ...
                    <div className="yb of">
                      <button className="hb od pd de se pf cg ph wh ci">
                        Create Account
                      </button>
                    </div>
                  </div>
