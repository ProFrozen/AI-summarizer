...
const Footer = () => {
  ...
  return <div className="wow fadeInUp ig zk oo" data-wow-delay=".2s"
    style={{ animationDelay: "0.2s", animationName: "none", backgroundColor: '#d1d1f7', color: "rgb(33, 33, 33)"}}>
    <div className="of op">
      <div className="ja hb md">
        <div className="yb of ok/2 wl/12 mn/12 pp/12">
          <div className="qa lc">
            <a href="https://go-tailwind.preview.uideck.com/index.html" className="ra gb">
              <img src={logo} alt="logo" className="kb ij" />
            </a>
            <p className="pa mh bi">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            </p>
            <div className="hb od td">
              <a href="javascript:void(0)" aria-label="social-link" className="bi _i ek">
        ...
        <div className="ac/2 of xl/12 mn/12 qp/12">
          <div className="qa">
            <h3 className="sa lh qh xh di _j">
              Company
            </h3>
            <ul className="ud">
              <li>
                <a href="javascript:void(0)" className="lh mh bi _i ek">
                  Home
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="javascript:void(0)" className="lh mh bi _i ek">
                  Careers
                  <span className="ta de se rf sf lh rh ci">
                    Hiring
                  </span>
                </a>
              </li>
        ...
        <div className="yb of ok/2 wl/12 mn/12 qp/12">
          <div className="qa">
            <h3 className="sa lh qh xh di _j">
              Get in touch
            </h3>
            <div className="vd">
              <div>
                <p className="lh mh bi">
                  Toll Free Customer Care
                </p>
                <a href="tel:+(1) 123 456 7890" className="lh mh di _i _j fk">
                  +(1) 123 456 7890
                </a>
              </div>
              <div>
                ...
                <a href="mailto:support@domain.com" className="lh mh di _i _j fk">
                  support@domain.com
                </a>
              </div>
            </div>
        ...
        <div className="yb of ok/2 wl/12 nn/12 pp/12">
          <div className="qa">
            <h3 className="sa lh qh xh di _j">
              Newsletter
            </h3>
            <p className="ra lh mh bi">
              Subscribe to receive future updates
            </p>
            <form className="e">
              <input type="email" name="email" id="email" placeholder="Email address"
                className="jq yb de he mf jg kg mh bi oi aj kj tj" />
              <button className="d k f hb ob bc od pd je bi lj">
                <svg width="20" height="20" viewBox="0 0 20 20" className="if">
                  <path
      ...
      <div className="jj bm">
        <div className="ja hb md tf dm">
          <div className="yb of yl/2 on/3">
            <div className="oa hb od pd td ie lg jj ll _l am im">
              <a href="javascript:void(0)" className="lh mh bi _i">
                English
              </a>
              <a href="javascript:void(0)" className="lh mh bi _i">
                Privacy Policy
          ...
          <div className="yb of yl/2 pn/3">
            <div>
              <p className="kh lh mh bi ap">
